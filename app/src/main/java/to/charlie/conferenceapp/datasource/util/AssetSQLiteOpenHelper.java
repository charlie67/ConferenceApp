package to.charlie.conferenceapp.datasource.util;
...
class AssetSQLiteOpenHelper implements SupportSQLiteOpenHelper
{
	...
	AssetSQLiteOpenHelper(Context context, String name, int version, Callback callback)
	{
		delegate = createDelegate(context, name, version, callback);
	}

	private AssetHelper createDelegate(Context context, String name, int version, final Callback callback)
	{
